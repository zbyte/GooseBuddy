...
public interface IAirCondition extends IBaseApi {
    public static enum AcDisplayPopup {
        ...
        private AcDisplayPopup(int value) {
            this.value = value;
        }

        public static AcDisplayPopup valueOf(int value) {
            if(value == AcDisplayPopup.SYNC.value) {
                return AcDisplayPopup.SYNC;
            }
            if(value == AcDisplayPopup.ION.value) {
                return AcDisplayPopup.ION;
            }
            if(value == AcDisplayPopup.ACMAX.value) {
                return AcDisplayPopup.ACMAX;
            }
            if(value == AcDisplayPopup.WIND_MODE_FRONT.value) {
                return AcDisplayPopup.WIND_MODE_FRONT;
            }
            if(value == AcDisplayPopup.RDEFROST.value) {
                return AcDisplayPopup.RDEFROST;
            }
            if(value == AcDisplayPopup.FDEFROST.value) {
                return AcDisplayPopup.FDEFROST;
            }
            if(value == AcDisplayPopup.CIRCULATION_MODE.value) {
                return AcDisplayPopup.CIRCULATION_MODE;
            }
            if(value == AcDisplayPopup.ACST.value) {
                return AcDisplayPopup.ACST;
            }
            if(value == AcDisplayPopup.AUTO_FRONT.value) {
                return AcDisplayPopup.AUTO_FRONT;
            }
            if(value == AcDisplayPopup.WIND_FRONT.value) {
                return AcDisplayPopup.WIND_FRONT;
            }
            if(value == AcDisplayPopup.PASSENGER_TEMPERATURE.value) {
                return AcDisplayPopup.PASSENGER_TEMPERATURE;
            }
            if(value == AcDisplayPopup.DRIVER_TEMPERATURE.value) {
                return AcDisplayPopup.DRIVER_TEMPERATURE;
            }
            if(value == AcDisplayPopup.ON_OFF.value) {
                return AcDisplayPopup.ON_OFF;
            }
            return value == AcDisplayPopup.NOT_REQUEST.value ? AcDisplayPopup.NOT_REQUEST : AcDisplayPopup.__UNKNOWN__;
        }
    }
    ...
    public static enum AirCirculationMode {
        ...
        private AirCirculationMode(int rx, int tx) {
            this.rx = rx;
            this.tx = tx;
            this.value = this.tx;
        }

        public static AirCirculationMode valueOf(int value) {
            if(value == AirCirculationMode.AUTO.rx) {
                return AirCirculationMode.AUTO;
            }
            return value == AirCirculationMode.MANUAL.rx ? AirCirculationMode.MANUAL : AirCirculationMode.__UNKNOWN__;
        }
    }
    ...
    public static enum AirCirculationState {
        ...
        INVALID(4),
        AUTO_OUT_AIR_CIRCULATION(0),
        __UNKNOWN__(-1);

        public final int value;

        private AirCirculationState(int value) {
            this.value = value;
        }

        public static AirCirculationState valueOf(int value) {
            if(value == AirCirculationState.INNER_AIR_CIRCULATION.value) {
                return AirCirculationState.INNER_AIR_CIRCULATION;
            }
            if(value == AirCirculationState.OUTSIDE_AIR_CIRCULATION.value) {
                return AirCirculationState.OUTSIDE_AIR_CIRCULATION;
            }
            if(value == AirCirculationState.AUTO_INNER_AIR_CIRCULATION.value) {
                return AirCirculationState.AUTO_INNER_AIR_CIRCULATION;
            }
            if(value == AirCirculationState.INVALID.value) {
                return AirCirculationState.INVALID;
            }
            return value == AirCirculationState.AUTO_OUT_AIR_CIRCULATION.value ? AirCirculationState.AUTO_OUT_AIR_CIRCULATION : AirCirculationState.__UNKNOWN__;
        }
    }
    ...
    public static enum AirQualitySnsConfig {
        ...
        private AirQualitySnsConfig(int rx, int tx) {
            this.rx = rx;
            this.tx = tx;
            this.value = this.tx;
        }

        public static AirQualitySnsConfig valueOf(int value) {
            if(value == AirQualitySnsConfig.HIGH.rx) {
                return AirQualitySnsConfig.HIGH;
            }
            if(value == AirQualitySnsConfig.NORMAL.rx) {
                return AirQualitySnsConfig.NORMAL;
            }
            return value == AirQualitySnsConfig.LOW.rx ? AirQualitySnsConfig.LOW : AirQualitySnsConfig.__UNKNOWN__;
        }
    }
    ...
    public static enum AutoMode {
        ...
        public static AutoMode valueOf(int value) {
            if(value == AutoMode.MANUAL_MODE.value) {
                return AutoMode.MANUAL_MODE;
            }
            return value == AutoMode.AUTO_MODE.value ? AutoMode.AUTO_MODE : AutoMode.__UNKNOWN__;
        }
    }
    ...
    public static enum ComfortCurveMode {
        ...
        private ComfortCurveMode(int rx, int tx) {
            this.rx = rx;
            this.tx = tx;
            this.value = this.tx;
        }

        public static ComfortCurveMode valueOf(int value) {
            if(value == ComfortCurveMode.SOFT.rx) {
                return ComfortCurveMode.SOFT;
            }
            if(value == ComfortCurveMode.NORMAL.rx) {
                return ComfortCurveMode.NORMAL;
            }
            return value == ComfortCurveMode.FAST.rx ? ComfortCurveMode.FAST : ComfortCurveMode.__UNKNOWN__;
        }
    }
    ...
    public static enum CupholderAutoMode {
        ...
        private CupholderAutoMode(int value) {
            this.value = value;
        }

        public static CupholderAutoMode valueOf(int value) {
            if(value == CupholderAutoMode.AUTO_MODE_OFF.value) {
                return CupholderAutoMode.AUTO_MODE_OFF;
            }
            return value == CupholderAutoMode.AUTO_MODE_ON.value ? CupholderAutoMode.AUTO_MODE_ON : CupholderAutoMode.__UNKNOWN__;
        }
    }
    ...
    public static enum CupholderHeatCoolMode {
        ...
        private CupholderHeatCoolMode(int value) {
            this.value = value;
        }

        public static CupholderHeatCoolMode valueOf(int value) {
            if(value == CupholderHeatCoolMode.OFF.value) {
                return CupholderHeatCoolMode.OFF;
            }
            if(value == CupholderHeatCoolMode.HEAT_MODE.value) {
                return CupholderHeatCoolMode.HEAT_MODE;
            }
            if(value == CupholderHeatCoolMode.COOL_MODE.value) {
                return CupholderHeatCoolMode.COOL_MODE;
            }
            return value == CupholderHeatCoolMode.NO_COMMAND.value ? CupholderHeatCoolMode.NO_COMMAND : CupholderHeatCoolMode.__UNKNOWN__;
        }
    }
    ...
    public static enum EcoMode {
        ...
        private EcoMode(int rx, int tx) {
            this.rx = rx;
            this.tx = tx;
            this.value = this.tx;
        }

        public static EcoMode valueOf(int value) {
            if(value == EcoMode.COMFORT.rx) {
                return EcoMode.COMFORT;
            }
            if(value == EcoMode.ECONOMY.rx) {
                return EcoMode.ECONOMY;
            }
            if(value == EcoMode.VENT.rx) {
                return EcoMode.VENT;
            }
            return value == EcoMode.INVALID.rx ? EcoMode.INVALID : EcoMode.__UNKNOWN__;
        }
    }
    ...
    public static enum FanSpeed {
        ...
        private FanSpeed(int rx, int tx) {
            this.rx = rx;
            this.tx = tx;
            this.value = this.tx;
        }
        ...
        public static FanSpeed valueOf(int value) {
            if(value == FanSpeed.LOW.rx) {
                return FanSpeed.LOW;
            }
            if(value == FanSpeed.NORMAL.rx) {
                return FanSpeed.NORMAL;
            }
            return value == FanSpeed.HIGH.rx ? FanSpeed.HIGH : FanSpeed.__UNKNOWN__;
        }
    }
    ...
    public static enum HumiditySnsDefAutoConfig {
        ...
        private HumiditySnsDefAutoConfig(int rx, int tx) {
            this.rx = rx;
            this.tx = tx;
            this.value = this.tx;
        }

        public static HumiditySnsDefAutoConfig valueOf(int value) {
            if(value == HumiditySnsDefAutoConfig.OFF.rx) {
                return HumiditySnsDefAutoConfig.OFF;
            }
            if(value == HumiditySnsDefAutoConfig.HIGH.rx) {
                return HumiditySnsDefAutoConfig.HIGH;
            }
            if(value == HumiditySnsDefAutoConfig.NORMAL.rx) {
                return HumiditySnsDefAutoConfig.NORMAL;
            }
            return value == HumiditySnsDefAutoConfig.LOW.rx ? HumiditySnsDefAutoConfig.LOW : HumiditySnsDefAutoConfig.__UNKNOWN__;
        }
    }
    ...
    public static enum IonPopReqDisplay {
        ...
        private IonPopReqDisplay(int value) {
            this.value = value;
        }

        public static IonPopReqDisplay valueOf(int value) {
            if(value == IonPopReqDisplay.NOT_ACTIVE.value) {
                return IonPopReqDisplay.NOT_ACTIVE;
            }
            return value == IonPopReqDisplay.ACTIVE.value ? IonPopReqDisplay.ACTIVE : IonPopReqDisplay.__UNKNOWN__;
        }
    }
    ...
    public static enum OnOffByVrState {
        ...
        private OnOffByVrState(int value) {
            this.value = value;
        }

        public static OnOffByVrState valueOf(int value) {
            if(value == OnOffByVrState.ON.value) {
                return OnOffByVrState.ON;
            }
            return value == OnOffByVrState.OFF.value ? OnOffByVrState.OFF : OnOffByVrState.__UNKNOWN__;
        }
    }
    ...
    public static enum PM25CleanReqCfg {
        ...
        private PM25CleanReqCfg(int value) {
            this.value = value;
        }

        public static PM25CleanReqCfg valueOf(int value) {
            if(value == PM25CleanReqCfg.NO_COMMAND.value) {
                return PM25CleanReqCfg.NO_COMMAND;
            }
            if(value == PM25CleanReqCfg.REQ.value) {
                return PM25CleanReqCfg.REQ;
            }
            return value == PM25CleanReqCfg.NOT_REQ.value ? PM25CleanReqCfg.NOT_REQ : PM25CleanReqCfg.__UNKNOWN__;
        }
    }
    ...
    public static enum PM25CleanReqDisplay {
        ...
        private PM25CleanReqDisplay(int value) {
            this.value = value;
        }

        public static PM25CleanReqDisplay valueOf(int value) {
            if(value == PM25CleanReqDisplay.NOT_ACTIVE.value) {
                return PM25CleanReqDisplay.NOT_ACTIVE;
            }
            return value == PM25CleanReqDisplay.ACTIVE.value ? PM25CleanReqDisplay.ACTIVE : PM25CleanReqDisplay.__UNKNOWN__;
        }
    }
    ...
    public static enum SceneDisplay {
        ...
        private SceneDisplay(int value) {
            this.value = value;
        }

        public static SceneDisplay valueOf(int value) {
            if(value == SceneDisplay.COMFORTSCENE.value) {
                return SceneDisplay.COMFORTSCENE;
            }
            if(value == SceneDisplay.FAST_COOLING_SCENE.value) {
                return SceneDisplay.FAST_COOLING_SCENE;
            }
            return value == SceneDisplay.FAST_WARMING_SCENE.value ? SceneDisplay.FAST_WARMING_SCENE : SceneDisplay.__UNKNOWN__;
        }
    }
    ...
    public static enum WindMode {
        ...
        private WindMode(int value) {
            this.value = value;
        }

        public static WindMode valueOf(int value) {
            if(value == WindMode.FACE.value) {
                return WindMode.FACE;
            }
            if(value == WindMode.FACE_FOOT.value) {
                return WindMode.FACE_FOOT;
            }
            if(value == WindMode.FOOT.value) {
                return WindMode.FOOT;
            }
            if(value == WindMode.FOOT_DEFROST.value) {
                return WindMode.FOOT_DEFROST;
            }
            if(value == WindMode.DEFROST.value) {
                return WindMode.DEFROST;
            }
            return value == WindMode.INVALID.value ? WindMode.INVALID : WindMode.__UNKNOWN__;
        }
    }
    ...
    public static enum WindSpeed {
        ...
        private WindSpeed(int value) {
            this.value = value;
        }

        public static WindSpeed valueOf(int value) {
            if(value == WindSpeed.LEVEL_1.value) {
                return WindSpeed.LEVEL_1;
            }
            if(value == WindSpeed.LEVEL_2.value) {
                return WindSpeed.LEVEL_2;
            }
            if(value == WindSpeed.LEVEL_3.value) {
                return WindSpeed.LEVEL_3;
            }
            if(value == WindSpeed.LEVEL_4.value) {
                return WindSpeed.LEVEL_4;
            }
            if(value == WindSpeed.LEVEL_5.value) {
                return WindSpeed.LEVEL_5;
            }
            if(value == WindSpeed.LEVEL_6.value) {
                return WindSpeed.LEVEL_6;
            }
            if(value == WindSpeed.LEVEL_7.value) {
                return WindSpeed.LEVEL_7;
            }
            return value == WindSpeed.OFF.value ? WindSpeed.OFF : WindSpeed.__UNKNOWN__;
        }
    }
